...
```
https://api.ghana-api.dev/api/v1/transport
```
...
```bash
curl -X GET "https://api.ghana-api.dev/api/v1/transport/stops?city=accra&type=bus_stop" \
...
```bash
curl -X GET "https://api.ghana-api.dev/api/v1/transport/nearby-stops?lat=5.6037&lng=-0.187&radius=500" \
  -H "Accept: application/json"
```
...
```bash
curl -X GET "https://api.ghana-api.dev/api/v1/transport/directions?start_lat=5.6037&start_lng=-0.187&end_lat=6.6885&end_lng=-1.6244&profile=driving-car" \
  -H "Accept: application/json"
```
...
```bash
curl -X GET "https://api.ghana-api.dev/api/v1/transport/directions?start_name=Kwame%20Nkrumah%20Circle,%20Accra&end_name=Kumasi%20Central%20Market&profile=driving-car" \
  -H "Accept: application/json"
```
...
```bash
curl -X GET "https://api.ghana-api.dev/api/v1/transport/travel-cost?distance=247.8&mode=car&fuel_efficiency=10" \
  -H "Accept: application/json"
```
...
```bash
# 1. Find nearby stops
curl -X GET "https://api.ghana-api.dev/api/v1/transport/nearby-stops?lat=5.6037&lng=-0.187&radius=1000"
...
curl -X GET "https://api.ghana-api.dev/api/v1/transport/travel-cost?distance=247.8&mode=car"
...
curl -X GET "https://api.ghana-api.dev/api/v1/transport/directions?start_name=Kotoka%20Airport&end_name=University%20of%20Ghana&profile=driving-car"
```
...
curl -X GET "https://api.ghana-api.dev/api/v1/transport/stops?city=kumasi&type=bus_stop"

# Estimate trotro fare
curl -X GET "https://api.ghana-api.dev/api/v1/transport/travel-cost?distance=15.5&mode=trotro"
```
